 ...
 * @author MONDHER
 */
public class CategoryManagerBackController implements Initializable {
    @FXML 
        ...
        Connection cnx = DataBase.getInstance().getCnx();
            ...
            while(rs.next()){
                 info.add(new Category (rs.getInt(1),rs.getString(2),rs.getString(3)));
                   ...
                   Logger.getLogger(CategoryManagerBackController.class.getName()).log(Level.SEVERE, null, ex);
               }  
           }
