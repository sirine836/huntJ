...
/*
   ...
   /* public void addToCart1(ActionEvent event) throws IOException,SQLException{ 
      ...
      Panier pa = new Panier(Config.currentUser,d.toString(),0,0,0);
      int id_produit = 1;
      Panier panier = new Panier();
      Panier panier1 = new Panier();
             panier = panierService.getCurrentPanierByUserID(Config.currentUser);
             panier1 = panierService.getCurPanierByUserIDetat(Config.currentUser);
             ...
             Lignepanier lp = new Lignepanier(id_produit,panier.getIdpan(),1);
                ...
                {
                    System.out.println(lpService.trouve(id_produit,Config.currentUser,panier.getIdpan()));
                    System.out.println(panier.getIdpan());
                  if(lpService.trouve(id_produit,Config.currentUser,panier.getIdpan())==true )
                    {
